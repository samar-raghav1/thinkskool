...
const FeaturePartVisual = () => {
  ...
  return (
    <div className="relative w-full h-[500px] lg:h-full flex items-center justify-center pt-8 pb-8 lg:pt-0 lg:pb-0">
      ...
      {/* Background Glow (Adjusted for white background context) */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-96 h-96 bg-blue-500/10 rounded-full blur-3xl opacity-30"></div>
      </div>

      {/* Main Feature Card */}
      <div className="relative z-10 w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 flex flex-col items-center justify-center min-h-[400px] border border-gray-100">
        ...
        {/* Video Lessons */}
        <motion.div
          className="floating-item absolute top-[10%] right-[-10%] bg-white rounded-full py-2 px-4 shadow-md flex items-center gap-2 border border-[#FF8C00] whitespace-nowrap text-sm"
          variants={floatVariants}
          initial="initial"
          animate="animate"
        >
          <i className="fas fa-play-circle" style={{ color: SECONDARY_BLUE }}></i>
          <span className="font-semibold text-gray-800">Video Lessons</span>
        </motion.div>

        {/* Code Editor */}
        <motion.div
          className="floating-item absolute top-[40%] left-[-10%] bg-white rounded-full py-2 px-4 shadow-md flex items-center gap-2 border border-[#FF8C00] whitespace-nowrap text-sm"
          variants={floatVariants}
          initial="initial"
          animate="animate"
        ...
        {/* Live Sessions */}
        <motion.div
          className="floating-item absolute bottom-[30%] right-[-10%] bg-white rounded-full py-2 px-4 shadow-md flex items-center gap-2 border border-[#FF8C00] whitespace-nowrap text-sm"
          variants={floatVariants}
          initial="initial"
          animate="animate"
        ...
        >
          ...
          <span className="font-semibold text-gray-800">Live Sessions</span>
        </motion.div>

        {/* Achievements */}
        <motion.div
          className="floating-item absolute bottom-[5%] left-[-10%] bg-white rounded-full py-2 px-4 shadow-md flex items-center gap-2 border border-[#FF8C00] whitespace-nowrap text-sm"
          variants={floatVariants}
          initial="initial"
          animate="animate"
...
const Feature = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-white w-full" id="feature-section">
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-800 mb-6 leading-tight">
            ...
            <ul className="text-left space-y-3 mb-10 max-w-xl lg:max-w-none mx-auto lg:mx-0">
              <li className="flex items-start text-gray-700">
                ...
                Setting the <strong className="text-gray-900">design style</strong> and visual direction in Figma
              </li>
              <li className="flex items-start text-gray-700">
                <span className="w-2 h-2 mr-3 mt-2 rounded-full shrink-0" style={{ backgroundColor: PRIMARY_COLOR }}></span>
                Adjusting AI-generated visuals to match your <strong className="text-gray-900">brand guidelines</strong>
              </li>
            </ul> 

           
            <button onClick={handleToggle}
              className="px-8 py-3 text-lg font-semibold rounded-lg border-2 flex transition duration-300 shadow-md hover:bg-orange-50 cursor-grab"
              style={{ 
                color: PRIMARY_COLOR, 
