...
    <section className="py-16 md:py-24 bg-white">
  <h2 className='text-6xl flex justify-center items-center font-bold mb-10'>About us</h2>
...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Who We Serve </h3>
...
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-4 z-10 pt-4">Our Core Approach</h2>
            {/* Large central icon */}
