...
const MentorSidebar = ({ isOpen, setOpen, navItems, activeFeature, setActiveFeature }) => (
  <div >
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold tracking-tight text-[#FF8C00]">Mentor Dashboard</h1>
        <button 
          onClick={() => setOpen(false)} 
