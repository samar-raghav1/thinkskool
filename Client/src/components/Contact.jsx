...
const Contact = () => {
    ...
    const handleBooking = ({ name, date }) => {
        // Here you would typically send the data to your backend API
        console.log(`Booking submitted by ${name} for date: ${date}`);
        alert(`Thank you, ${name}! Your demo call is tentatively booked for ${new Date(date).toLocaleString()}. We will be in touch shortly.`);
        // Add your actual API call logic here (e.g., axios.post('/api/bookings', { name, date }))
    };
