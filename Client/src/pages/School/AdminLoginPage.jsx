import {  LogIn, LogOutIcon, Shield, User } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center space-x-3 pb-2 border-b border-gray-100">
        <Shield className={`${PRIMARY_COLOR} w-6 h-6`} />
        <h3 className={`text-xl font-bold ${PRIMARY_COLOR}`}>Admin Login</h3>
      </div>
