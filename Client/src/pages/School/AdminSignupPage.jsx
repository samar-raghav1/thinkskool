import { Shield, UserPlus, LogOutIcon } from 'lucide-react';
            ...
            <div className="relative z-10 w-full max-w-md p-8 bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-800">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    <div className="flex items-center justify-center space-x-3 pb-4">
                        ...
                        <h3 className="text-2xl font-bold text-white">Admin Signup</h3>
                    </div>
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <><UserPlus className="w-5 h-5" /> Sign Up as Admin</>
                        )}
                    </button>
                    ...
                    <div className="text-center mt-4">
                        <p className="text-sm text-slate-400">
                            ...
                            <Link to="/admin/login" className="text-purple-400 font-semibold hover:text-purple-300 hover:underline">
                                Log In
                            </Link>
                        </p>
                    </div>
