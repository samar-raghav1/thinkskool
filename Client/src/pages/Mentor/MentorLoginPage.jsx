import {  BookOpen, LogIn, LogOutIcon, User } from 'lucide-react';
...
const MentorLoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      if (adminId === 'mentor' && password === 'mentor') {
       navigate("/mentor")
      } else {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center space-x-3 pb-2 border-b border-gray-100">
        <BookOpen className={`${PRIMARY_COLOR} w-6 h-6`} />
        <h3 className={`text-xl font-bold ${PRIMARY_COLOR}`}>Mentor Login</h3>
      </div>
